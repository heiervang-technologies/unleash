...
The unleash repository integrates with snail-core-template to enable GitHub Actions-based AI agent automation. This guide explains how the snail system works, how to configure workflows, and how plugins enhance the agent's capabilities.
...
The unleash repository includes these workflows:
