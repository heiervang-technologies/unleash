...
| Document | Description |
|----------|-------------|
| [Plugin Development](extensions/plugin-development.md) | Creating custom plugins |
| [Testing Guide](extensions/testing-guide.md) | Testing strategies and CI |
| [Snail Integration](extensions/snail-integration.md) | GitHub Actions agent automation |
