# CLI Conversation Format Overview
...
These features exist across all 4 CLIs and can be converted without loss:
...
Features unique to one or two CLIs:
...
How message roles map across CLIs:
...
- [Claude Code](claude-code.md) — full format reference
- [Codex](codex.md) — full format reference
- [Gemini CLI](gemini-cli.md) — full format reference
- [OpenCode](opencode.md) — full format reference
